              ...
              <Row className="mb-4 g-4">
                <Col md={4}>
                  <Card
                    ...
                    onClick={() => router.push(`/organizers/${userId}/create-event?type=paid`)} // This will navigate to the create-event page
                  >
                    <Card.Body>
                ...
                <Col md={4}>
                  <Card
                    ...
                    onClick={() => router.push(`/organizers/${userId}/create-event?type=free`)}
                  >
                    <Card.Body>
