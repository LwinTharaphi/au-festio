                  ...
                  <CardActionArea>
                    {event.posterName && (
                      ...
                      <CardMedia 
                        ...
                        height="140"
                        image={
                          event.poster.startsWith('data:image/')  // Check if it's base64
                            ? event.poster  // If it's base64, directly use it
                            : `/uploads/posters/${event.poster}`  // Otherwise, treat it as a file path
                        }
