...
export async function GET(request, { params }) {
  ...
  try {
    ...
    if (event.poster && event.poster.$binary && event.poster.$binary.base64) {
      const posterBase64 = event.poster.$binary.base64;
      const posterDataUrl = `data:image/jpeg;base64,${posterBase64}`;
